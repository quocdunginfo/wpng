 ...
 */
namespace Wpng;
Wpng::loadView(WPNG_MODULE, '_shared', 'blank');
class HomeIndexView extends _SharedMainView {
...
<!DOCTYPE html>
<html lang="en" ng-app="WpngApp" ng-controller="homeController">
	<head>
		...
		<!-- BEGIN quocdunginfo -->
		<?php
		WpngBundle::renderBundle(WpngBundle::getJquery());
		WpngBundle::renderBundle(WpngBundle::getAngularJs());
		WpngBundle::renderBundle(WpngBundle::getJqWidget());
		?>
		<script>
			var Wpng = {};
			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<!-- /section:settings.box -->
						<div class="row">
							<div class="col-xs-12" ng-include src="wpngMainContentTemplatePath">
								<!-- PAGE CONTENT BEGINS -->
